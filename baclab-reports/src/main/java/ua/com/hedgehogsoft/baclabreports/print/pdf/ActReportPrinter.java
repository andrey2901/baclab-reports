...
public class ActReportPrinter
{
   ...
   public File print(JTable table, String dateFrom, String dateTo, String source)
   {
      File file = null;
      try
      {
         ...
         file = new File(System.getProperty("report.folder") + "/Акт_списання_" + source + "_" + dateFrom + "_" + dateTo
               + ".pdf");
